    ...
    <div className="bg-gray-50 py-8 px-4 lg:px-12">
      <div className="max-w-5xl mx-auto text-gray-800">
        <div className="flex items-center space-x-3 mb-4">
          ...
          <h6 className="text-3xl font-semibold">Refund Policy</h6>
        </div>
        ...
        <p className="mt-5">
          Please note that all sales are final for the first quarter of service.
          By reviewing our performance records and making a payment for the
          subscription, you agree to these terms. After the first quarter,
          service adjustments may be discussed, but no refunds will be issued
          within this period.
        </p>
        <p className="mt-5">
          ...
          unforeseen reason, the client is not satisfied with our services, they
          may contact us for guidance on future recommendations. We will make
          every effort to address their concerns, but requests to cancel
          services or obtain refunds within the first quarter will not be
          entertained.
        </p>
        <p className="mt-5">
          In the rare event that, after payment, the service for a client is not
          initiated due to technical reasons beyond the control of Trade Gyan
          Solutions, or if Trade Gyan Solutions decides not to start service for
          a specific client, the client will be reimbursed as soon as possible.
          This does not apply if the client is unable to receive notifications
          due to DND (Do Not Disturb) status. If our service provider confirms
          that messages were sent to the client’s provided number, this will be
          considered as service delivery from our end, and no refund will be
          issued based on non-delivery due to DND. We advise clients to
          de-register from DND before making a payment or immediately after the
          service begins.
        </p>
        <p className="mt-5">
          By making a payment to Trade Gyan Solutions, customers agree to submit
          KYC (Know Your Client) documents to Trade Gyan Solutions or their
          broker (to be added or updated in the KRA database). Failure to update
          KYC will result in a hold on the service, and no refund will be
          provided. The service will begin only after the customer’s KYC and CRP
          are satisfactorily updated.
        </p>
        ...
        <p className="mt-5">
          ...
          accessed by unauthorized persons to prevent any unauthorized payments
          for subscriptions.
        </p>
        <p className="mt-5">
          ...
          We are confident that you will find our advisory services beneficial.
        </p>
      </div>
    </div>
  );
