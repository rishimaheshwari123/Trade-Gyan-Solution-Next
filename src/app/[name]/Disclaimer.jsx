...
const policiesData = [
    ...
    content: [
      {
        ...
        points: [
          "As a supreme global employer with remarkable business partnerships,  TradeGyan Solutions Investment Adviser is accomplishing towards maintaining and promoting world-class standards of business nobility.",
          " TradeGyan Solutions values, which incorporate principles of corporate social responsibility (CSR) and sustainability, guide our relationships with clients, employees, and the communities we work in.",
  ...
  },
  {
    ...
    content: [
      {
        points: [
          "An individual should also keep this mind that the  TradeGyan Solutions Investment Adviser can change the terms and conditions and we assume that the client accept these modified terms and conditions. Hence, it is recommended to keep visiting the link of ‘Terms & Condition’ of the site on regular basis to stay updated about the newly introduced or any modified terms or conditions of the  TradeGyan Solutions.",

          " TradeGyan Solutions is neither liable to any kind of liability or loss resulting, indirectly or directly, from interruptions or delays due to the mechanical or electronic machine failures, telephone connection defect, strikes, weather, walkouts, strikes, acts of God, fire, armed conflicts, riots, acts of war or any other causes. The site shall have no liability to provide you the access to the  TradeGyan Solutions.com due to the interruption of the site in any of such causes continues.",

          "You willingly agree that you use this site as on your own risk. The information, content, product, features, service, software published on this site may also include errors or inaccuracy. Modifications are regularly added to content. The Investment Adviser or the respective suppliers may do some changes or improvement in this site at any time period. This website may also be remaining temporary unavailable due to some problems, maintenance or any sort of other problems.  TradeGyan Solutions.com shall not be responsible to member or user to discontinue to modify all or any of contents, software, information, products, services and features that get published in the site.",
          ...
          " TradeGyan Solutions does not offer guaranteed accuracy, timeliness, or completeness of, or otherwise approve in either way, the opinions, recommendations, or views expressed in information.  TradeGyan Solutions does not offer investment advice and at the same time does not advocate the sale or purchase of any investment or security by the client or any third party. The user information is not intended to provide legal, investment, or tax advice that you should get from a professional advisor prior to making any investment of the type discussed in the information.",
          ...
          "While using the Site, you agree not to inhibit others from using the Site, deface the Site, or in any way do anything that would be dishonest or harmful to others.  TradeGyan Solutions.com as well as the design and information contained in this site is valuable and exclusive property of  TradeGyan Solutions.com, and nothing in this Agreement shall be construed as transferring or assigning any such ownership rights to you or any other person or entity.",

          "You cannot resell or transfer the information or use the information on  TradeGyan Solutions.com. You may not distribute, transfer, copy, publicly display, and publish  TradeGyan Solutions.com, any part thereof, or any of the information received or accessed therefrom to or through any other person or entity.",
    ...
    content: [
      {
        ...
        points: [
          " TradeGyan Solutions respects and values the right to Privacy of each and every individual.",

          "We are esteemed by the relationship and by becoming our clients you have a promise from our side that we shall remain loyal to all our clients and non-clients whose information resides with us. This Privacy Policy of  TradeGyan Solutions applies to the current clients as well as former clients.",

          "In addition to the service provided to you, your information (Mobile Number, E-Mail ID, etc.) can be brought in use for sending you newsletters, survey, contest information, or information about any new services of  TradeGyan Solutions which will be for your own good. While subscribing for our services, you agree that  TradeGyan Solutions has the right to do so.",

          "We would like to share our privacy policies with our clients in order to maintain transparency as follows:",

          "In general,  TradeGyan Solutions collects consumer opinions, their email addresses, phone numbers, and other relevant information in order to provide services of value to our members. We generally use this information in three ways:",
          ...
          "After filling in the details, if a customer wants to change the information, he/she can drop an email at: support@ TradeGyan Solutions.com.",

          "Calls will be given through SMS.",

          "We are authorized to change this privacy policy from time to time. We will be posting all the updates and modifications on our website www. TradeGyan Solutions.com, so please be sure to check the same periodically.",
    ...
    content: [
      {
        ...
        points: [
          ...
          "While making investment advice,  TradeGyan Solutions makes an adequate disclosure to our client of all material facts relating to the key features of the products or securities, particularly performance track records.",

          " TradeGyan Solutions always draws the client’s attention in the form of warnings and disclaimers in documents and advertising materials related to the investment products which we are recommending to our client.",
          ...
          "To ensure compliance with the Investment Advisor Regulations 2013,  TradeGyan Solutions and all its representatives will not make any trades in the market.",
          ...
          "We advise every client to check and seek his/her suitability, profiling, and investor category to ensure that recommended services are compatible with their profile.  TradeGyan Solutions does not offer low-risk services. Any investor with a medium-risk appetite is recommended to subscribe to medium-risk services, and an investor with a high-risk appetite is recommended to subscribe to either medium or high-risk services.",
          ...
          "No litigation has been filed against  TradeGyan Solutions Investment Adviser since its incorporation.",
          ...
          " TradeGyan Solutions Investment Adviser is not involved in trading of its own.",
