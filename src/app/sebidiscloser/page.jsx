      ...
      <section className="max-w-5xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="mt-4">
            ...
            <br />
            <strong>Mission:</strong> Every investor should be able to invest in
        ...
        <div className="mb-8">
          ...
          <ul className="list-disc list-inside mt-4 space-y-2">
            ...
            <li>
              Conduct unbiased risk profiling and suitability assessment of the
              client.
            </li>
            <li>
            ...
            <li>
              Display details like name, registration type, number, address, and
              SEBI office details on its website.
            </li>
            <li>Employ qualified and certified staff.</li>
            <li>Use official numbers only for client interaction.</li>
            <li>
              Maintain records of all client interactions, including prospective
              ones, prior to onboarding.
            </li>
          </ul>
        </div>
        ...
        <div className="mb-8">
          ...
          <p className="mt-4">
            ...
            within 30 days.
            <br />
            <strong>2.</strong> If the complaint isn’t resolved satisfactorily,
            investors can lodge complaints with SEBI through its ‘SCORES’
            portal, a centralized system to track complaints.
            <br />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-4">
            <div>
              ...
              <ul className="list-disc list-inside mt-2 space-y-2">
                ...
                <li>
                  Check for SEBI registration number. Refer to SEBI’s registered
                  IAs list on their website.
                </li>
                <li>
                ...
                <li>
                  Clear all doubts with your Investment Adviser before acting on
                  advice.
                </li>
                <li>
                ...
                <li>
                  Insist on written terms and conditions before dealing with an
                  Investment Adviser.
                </li>
            ...
            <div>
              ...
              <ul className="list-disc list-inside mt-2 space-y-2">
                <li>
                  Don’t fall for stock Recommendation under the pretext of
                  investment advice.
                </li>
                <li>
                  Don’t provide funds for investment to the Investment Adviser.
                </li>
                <li>
                ...
                <li>
                  Don’t share login credentials and passwords of your trading or
                  demat accounts.
                </li>
              </ul>
            </div>
...
export const generateMetadata = () => {
  return {
    title: " SEBI Disclosures - TradeGyan Solutions",
    description:
    ...
    openGraph: {
      type: "website",
      url: "https://www.tradegyan.co/sebidiscloser",
      title: "SEBI Disclosures - TradeGyan Solutions",
      description:
