...
const ServiceCard = ({ service }) => {
    ...
    return (
        <Link href={`/trader/service/${service?.serviceId}`} className="service-card border border-gray-300 bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 transform hover:-translate-y-1">
