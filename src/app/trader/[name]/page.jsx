...
function TraderDatas({params}) {
  const {name} = params; // Get the name (equity, commodity, etc.) from the URL
    ...
    <>
      <div className="mt-[50px]">
        <div className="flex  flex-col justify-center items-center w-[90%] md:w-[80%] mx-auto text-center mb-10">
          <h4 className="text-5xl text-blue-500 font-semibold font-serif mb-6">
            Intraday
          </h4>
          <p className="text-lg my-3 leading-relaxed text-gray-800">
            Intraday Trading requires frequent buying and selling of stocks
            within the same day. Trade Gyan Solutions provides Best Intraday
            Trading Strategies for aggressive traders. Our Intraday Trading
            services are designed to help you make the most of the market
