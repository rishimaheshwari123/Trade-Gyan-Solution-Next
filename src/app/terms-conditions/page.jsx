      ...
      <div className="min-h-screen bg-gray-100 p-6">
        <div className="max-w-4xl mx-auto bg-white p-8 shadow-lg rounded-lg">
          ...
          <div className="flex items-center mb-2">
            ...
            <span> 7771004878 , +917771004879</span>
          </div>
...
export const generateMetadata = () => {
  return {
    title: "Terms & Conditions - TradeGyan Solutions",
    description:
    ...
    openGraph: {
      ...
      title: "Terms & Conditions - TradeGyan Solutions",
      description:
        "Terms & Conditions about TradeGyan Solutions, a financial market research and consulting company with a 10+ year legacy, providing expert analysis and solutions for the trading community.",
      image: "/logo192.png",
    },
