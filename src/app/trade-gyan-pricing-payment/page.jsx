        ...
        <div className="max-w-7xl mx-auto p-6">
          <div className="bg-white shadow-md rounded-lg p-6 text-center">
            ...
            <p className="text-gray-700">
              ...
              unbiased, transparent, SEBI Compliant, free from any hidden
              charges or commissions, and backed by the extensive experience of
              the team at Trade Gyan Solutions.
            </p>
          </div>
        </div>
      </div>
