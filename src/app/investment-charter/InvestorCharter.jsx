      ...
      <div className="max-w-5xl mx-auto bg-white p-8 shadow-lg rounded-lg">
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6">
            ...
            <li>
              To disclose company details such as name, proprietor, registration
              number, address, and SEBI office details on its website.
            </li>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6">
            <li>
              An investor should approach the Investment Adviser and ensure the
              grievance is resolved within 30 days.
            </li>
            <li>
              If not resolved, lodge a complaint with SEBI on the
              &apos;SCORES&apos; portal, a web-based redressal system for
              tracking the status of complaints.
            </li>
            <li>
              Physical complaints can be sent to: Office of Investor Assistance
        ...
        <section className="mb-8">
          ...
          <div>
            ...
            <ul className="list-disc pl-6">
              ...
              <li>
                Don’t rush into investments that don’t match your goals or risk
                appetite.
              </li>
              <li>
